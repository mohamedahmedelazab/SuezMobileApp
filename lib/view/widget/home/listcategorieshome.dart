                     ...
                     child: Column(
                       ...
                       children: [
                        Container(
                          height: 100,
                               decoration: BoxDecoration(
                                 ...
                                 image: DecorationImage(
                                   image: NetworkImage("${AppLink.imagesCategories}/${controller.categories[0]["categories_image"]}",),
                         ...
                         SizedBox(height: 10),
                         Text(controller.categories[0]["categories_name"], maxLines: 1,  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
                         SizedBox(height: 3),
                         Text(controller.categories[0]["categories_name_en"], style: TextStyle(color: Colors.grey, fontSize: 13),),
                         /* SizedBox(height: 3),
                  Row(
                    children: [
                         ...
                         children: [
                           Container(
                               ...
                               decoration: BoxDecoration(
                                 borderRadius: BorderRadius.circular(20),
                                 image: DecorationImage(
                                   image: NetworkImage("${AppLink.imagesCategories}/${controller.categories[1]["categories_image"]}",),
                           ...
                           SizedBox(height: 10),
                           Text(controller.categories[1]["categories_name"], maxLines: 1,  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
                           SizedBox(height: 3),
                           Text(controller.categories[1]["categories_name_en"], style: TextStyle(color: Colors.grey, fontSize: 13),),
                           /* SizedBox(height: 3),
                  Row(
                    children: [
                      Icon(Icons.star, color: Colors.yellow, size: 14,),
                  ...
                  children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          image: DecorationImage(
                            image: NetworkImage("${AppLink.imagesCategories}/${controller.categories[2]["categories_image"]}",),
                    ...
                    SizedBox(height: 10),
                    Text(controller.categories[2]["categories_name"], maxLines: 1,  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
                    SizedBox(height: 3),
                    Text(controller.categories[2]["categories_name_en"], style: TextStyle(color: Colors.grey, fontSize: 13),),
                    ...
                    children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20),
                            image: DecorationImage(
                              image: NetworkImage("${AppLink.imagesCategories}/${controller.categories[3]["categories_image"]}",),
                      ...
                      SizedBox(height: 10),
                      Text(controller.categories[3]["categories_name"], maxLines: 1,  style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
                      SizedBox(height: 3),
                      Text(controller.categories[3]["categories_name_en"], style: TextStyle(color: Colors.grey, fontSize: 13),),
